          ...
          <div className="flex justify-center">
            <div className="w-full max-w-md rounded-lg overflow-hidden shadow-lg">
              <MotionButton
                ...
                className="w-full px-8 py-4 bg-blue-600 text-white hover:bg-blue-700 transform hover:scale-[1.01] transition-all duration-300 flex items-center justify-center gap-3"
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full px-8 py-4 bg-blue-500 text-white hover:bg-blue-600 transition-colors duration-300 flex items-center justify-center border-t border-blue-300/70"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                View Resume
            ...
            >
              <div className="md:w-[65%] p-6">
                ...
                <div className="mt-5 flex flex-wrap items-center gap-5">
                  ...
                  <motion.a
                    href="/INTERNSHIP_DIARY_2026.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors"
                    whileHover={{ scale: 1.05 }}
              ...
              <div className="md:w-[35%] min-h-[220px] p-6 flex items-center justify-center bg-white dark:bg-gray-900 md:rounded-r-lg rounded-b-lg md:rounded-b-none">
                <Image
                  src="/images/ionialogo.png"
                  alt="Ionia Technology LLP internship"
                  width={320}
                  height={180}
